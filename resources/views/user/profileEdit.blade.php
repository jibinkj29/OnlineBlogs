                ...
                <div class="side-app">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0 text-primary">Profile Edit</h4>
                        </div>
                ...
                <div class="btn-list">             
                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-warning alert-block" id="alert" style="display: none;"></div>
                                    ...
                                    <form  method="POST" action="{{ route('user.profileUpdate') }}" id="blog-upload" enctype='multipart/form-data' >
                                        @method('PUT')
                                        @csrf
                                        
                                    <input type="hidden" name="dbid" value="{{ $User->first()->id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ $User->first()->name }}" class="form-control"  placeholder="Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" value="{{$User->first()->email}}" class="form-control"  placeholder="Email">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
