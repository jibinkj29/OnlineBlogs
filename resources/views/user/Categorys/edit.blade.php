                ...
                <div class="side-app">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0 text-primary">Category Edit</h4>
                        </div>
                ...
                <div class="btn-list">             
                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-warning alert-block" id="alert" style="display: none;"></div>
                                    ...
                                    <form  method="POST" action="{{ route('categories.update', ['category' => $category->id]) }}" id="blog-upload" enctype='multipart/form-data' >
                                        @method('PUT')
                                        @csrf
                                        
                                    <input type="hidden" id="dbid" value="{{ $category->id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ $category->name }}" class="form-control" var blogId = formData.get('id');  placeholder="Name">
                                            </div>
                                        </div>
